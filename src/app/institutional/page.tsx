          ...
          <div>
            ...
            >
              <div>
                ...
                <h2 style={{ margin: 0 }}>
                  {orgs.length} connected {orgs.length === 1 ? "institution" : "institutions"}
                </h2>
              </div>
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          <p style={{ opacity: 0.62, marginTop: 0, marginBottom: 24 }}>
                            {verified
                              ? "Verified institutional issuer in the HPS trust network."
                              : "Institution account created. Verification is required before trusted issuance."}
                          </p>
                          ...
                          >
                            <div style={{ display: "flex", justifyContent: "space-between", gap: 16, fontSize: 14 }}>
                              <span style={{ opacity: 0.58 }}>Your role</span>
                              <strong>{roleLabel(o.role)}</strong>
                            </div>

                            <div style={{ display: "flex", justifyContent: "space-between", gap: 16, fontSize: 14 }}>
                              <span style={{ opacity: 0.58 }}>Status</span>
                              <strong>{verified ? "✓ Verified" : "Pending"}</strong>
                            </div>

                            <div style={{ display: "flex", justifyContent: "space-between", gap: 16, fontSize: 14 }}>
                              <span style={{ opacity: 0.58 }}>Capability</span>
                              <strong>{verified ? "HPS issuance" : "Awaiting verification"}</strong>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <strong style={{ fontSize: 14 }}>Open institution →</strong>
                        </div>
                      </article>
                    </Link>
                  );
