...
This drop-in package extends the existing Human Provenance Standard with a Catalyst-focused research agent and a real Microsoft Word task-pane proof of concept.
...
- `docs/CATALYST-DEMO.md` — prior document-aware demo flow
